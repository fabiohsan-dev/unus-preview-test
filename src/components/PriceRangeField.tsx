  ...
  return (
    <div className="relative flex-1 min-w-0">
      <button
        ref={triggerRef}
        type="button"
        className={`w-full flex items-center gap-3 cursor-pointer hover:bg-[rgba(247,244,239,0.78)] rounded-[14px] transition-colors text-left ${
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 bg-white rounded-[14px] shadow-[0_18px_42px_rgba(0,0,0,0.12)] border border-[var(--neutral-200)] p-4 z-[200] w-[300px]"
          ...
          >
            ...
            >
              <SliderPrimitive.Track className="relative flex-1 h-[2px] rounded-full bg-[var(--neutral-200)]">
                <SliderPrimitive.Range className="absolute h-full rounded-full bg-[var(--primary-500)]" />
              </SliderPrimitive.Track>
              <SliderPrimitive.Thumb className="block w-5 h-5 bg-white border-2 border-[var(--primary-500)] rounded-full shadow-md cursor-grab active:cursor-grabbing focus:outline-none focus:ring-2 focus:ring-[var(--secondary-900)]/20" />
              <SliderPrimitive.Thumb className="block w-5 h-5 bg-white border-2 border-[var(--primary-500)] rounded-full shadow-md cursor-grab active:cursor-grabbing focus:outline-none focus:ring-2 focus:ring-[var(--secondary-900)]/20" />
            </SliderPrimitive.Root>
            ...
            <div className="flex items-center gap-2 mb-5">
              <input
                ...
                onBlur={commitMin}
                className="flex-1 min-w-0 rounded-[10px] bg-[rgba(247,244,239,0.94)] px-3 min-h-[42px] text-[14px] text-[var(--color-heading)] border border-[var(--neutral-200)] outline-none focus:border-[var(--primary-500)] transition-colors"
            ...
            <div className="flex justify-end gap-2">
              <button
                type="button"
                onClick={reset}
                className="min-h-[42px] px-5 py-2 text-[12px] text-[var(--color-body)] bg-[var(--neutral-100)] rounded-[12px] hover:bg-[var(--neutral-200)] transition-colors cursor-pointer uppercase tracking-[0.12em]"
              ...
              <button
                ...
                className="min-h-[42px] px-5 py-2 text-[12px] text-white bg-[var(--primary-500)] rounded-[12px] hover:bg-[var(--deep-blue-700)] transition-colors cursor-pointer uppercase tracking-[0.12em]"
